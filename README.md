...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/new/?editor=code#https://github.com/crytic/ethereum-package)
...
3. Run the package with default configurations from the command line:
   ...
   ```bash
   kurtosis run --enclave my-testnet github.com/crytic/ethereum-package
   ```
...
```bash
kurtosis run --enclave my-testnet github.com/crytic/ethereum-package --args-file network_params.yaml
```
...
```
kurtosis run github.com/crytic/ethereum-package '{"mev_type": "full"}'
```
...
This package comes with [seven prefunded keys for testing](https://github.com/crytic/ethereum-package/blob/main/src/prelaunch_data_generator/genesis_constants/genesis_constants.star).
