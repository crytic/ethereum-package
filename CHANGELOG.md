...
## [3.0.0](https://github.com/crytic/ethereum-package/compare/2.2.0...3.0.0) (2024-05-06)


### ⚠ BREAKING CHANGES

* add mev-rs relay/builder/boost ([#586](https://github.com/crytic/ethereum-package/issues/586))
* upcoming file path change in kurtosis upstream ([#582](https://github.com/crytic/ethereum-package/issues/582))

### Features

* add apache file server ([#581](https://github.com/crytic/ethereum-package/issues/581)) ([205256a](https://github.com/crytic/ethereum-package/commit/205256a6d79303719973655b459e803d9b8e311f))
* add enr/enode to apache ([#589](https://github.com/crytic/ethereum-package/issues/589)) ([b789e17](https://github.com/crytic/ethereum-package/commit/b789e1705f076ec6aa01ceffbf5fbeebb02d8c0f))
* add execution client urls to dora config ([#588](https://github.com/crytic/ethereum-package/issues/588)) ([2a20d5a](https://github.com/crytic/ethereum-package/commit/2a20d5ad7d2bf8f9a9eb2b619681b438810176d2))
* add mev-rs relay/builder/boost ([#586](https://github.com/crytic/ethereum-package/issues/586)) ([525a8fb](https://github.com/crytic/ethereum-package/commit/525a8fb3d794f8030a574f55f3a7e719c1b58dca))
* Add peerdas support ([#591](https://github.com/crytic/ethereum-package/issues/591)) ([14296ca](https://github.com/crytic/ethereum-package/commit/14296cab11d8c7a9572cf57a37980e1d93285cad))
* add snooper urls to assertoor config ([#571](https://github.com/crytic/ethereum-package/issues/571)) ([87f383f](https://github.com/crytic/ethereum-package/commit/87f383fbc7f9e28d383853fcb7cd491abe13a0cc))
* allow setting exit ip address ([#584](https://github.com/crytic/ethereum-package/issues/584)) ([aabc942](https://github.com/crytic/ethereum-package/commit/aabc942c4e8534288f28cdbb1e9e55f2613f383c))


### Bug Fixes

* non-existent field access on error message ([#577](https://github.com/crytic/ethereum-package/issues/577)) ([8515d27](https://github.com/crytic/ethereum-package/commit/8515d276056a47f9e6a77dd498f823042bff1a8f))
* participant redefining global flag ([#573](https://github.com/crytic/ethereum-package/issues/573)) ([9139f4b](https://github.com/crytic/ethereum-package/commit/9139f4b4c77bc43477740972512171d7f28bfa84))
* path for shadowforks post kt update ([#585](https://github.com/crytic/ethereum-package/issues/585)) ([e0622a7](https://github.com/crytic/ethereum-package/commit/e0622a77305732e01ee0fce183fda15c3dcd2dad))
* remove erigon's --chain parameter ([#575](https://github.com/crytic/ethereum-package/issues/575)) ([02b9c50](https://github.com/crytic/ethereum-package/commit/02b9c50495f9b8cce0b0df502f19b37c0cb21ffd))
* upcoming file path change in kurtosis upstream ([#582](https://github.com/crytic/ethereum-package/issues/582)) ([8d7c4f9](https://github.com/crytic/ethereum-package/commit/8d7c4f9c1feba07511c22d006b5121b45893f642))

## [2.2.0](https://github.com/crytic/ethereum-package/compare/2.1.0...2.2.0) (2024-04-19)


### Features

* add assertoor test for per PR CI job ([#537](https://github.com/crytic/ethereum-package/issues/537)) ([8ef5c57](https://github.com/crytic/ethereum-package/commit/8ef5c57fc00b1e5ea9d59011fa61d771b1af5133))
...
* add --contract-deployment-block parameter for Prysm ([#557](https://github.com/crytic/ethereum-package/issues/557)) ([d8dfbae](https://github.com/crytic/ethereum-package/commit/d8dfbae531c038e3985cb15ca6bcbcf37f6526a0))
* Added '--enable-private-discovery' to Grandine ([#541](https://github.com/crytic/ethereum-package/issues/541)) ([a1ae708](https://github.com/crytic/ethereum-package/commit/a1ae708183873dec97e91986d6104c8dedc92100))
* beaconchain explorer ([#531](https://github.com/crytic/ethereum-package/issues/531)) ([b62ed6f](https://github.com/crytic/ethereum-package/commit/b62ed6f129c65b62f084ea2a78fab0fa80afd9e2))
* beaconchain explorer ([#538](https://github.com/crytic/ethereum-package/issues/538)) ([ce1f337](https://github.com/crytic/ethereum-package/commit/ce1f3373000d552a9b4b8b09ad5754ab092a61cb))
* blobber incorrect url ([#528](https://github.com/crytic/ethereum-package/issues/528)) ([6f84e3d](https://github.com/crytic/ethereum-package/commit/6f84e3d5ec5fd7c02016530b3b64c79114d5891e))
* bump json rpc snooper ([#553](https://github.com/crytic/ethereum-package/issues/553)) ([f69c4a7](https://github.com/crytic/ethereum-package/commit/f69c4a7468f97a4aa3aaea64dd18a63e561a6704))
* disable full sync if gcmode is archive ([#563](https://github.com/crytic/ethereum-package/issues/563)) ([b7592ec](https://github.com/crytic/ethereum-package/commit/b7592ecac5ca8820aa6de6fc5ae9bb9c0dc27c20))
* disable pbss when gcmode archive set ([#559](https://github.com/crytic/ethereum-package/issues/559)) ([e085462](https://github.com/crytic/ethereum-package/commit/e0854624ef69a069bb7ba482694cb83180df0680))
* disable pbss when gcmode archive set, force hash based init ([#562](https://github.com/crytic/ethereum-package/issues/562)) ([3e1c7a6](https://github.com/crytic/ethereum-package/commit/3e1c7a6585a50398e5750f6e37cf3d0685d35536))
* disable static peers ([#529](https://github.com/crytic/ethereum-package/issues/529)) ([c5d4028](https://github.com/crytic/ethereum-package/commit/c5d4028939691b887b928b91532f8139478ee4d2))
* enable single node mode on lodestar by default ([#558](https://github.com/crytic/ethereum-package/issues/558)) ([555ad7d](https://github.com/crytic/ethereum-package/commit/555ad7dc5180cc7f47e14baa3438879e6d4779e9))
* fix doc string typo ([#560](https://github.com/crytic/ethereum-package/issues/560)) ([13de3f6](https://github.com/crytic/ethereum-package/commit/13de3f68706a80088b28fbfefc69d738e06d13ef))
* fix failing persistence test ([#554](https://github.com/crytic/ethereum-package/issues/554)) ([99242d6](https://github.com/crytic/ethereum-package/commit/99242d66f3e0254684b75bce14353a854e735721))
* increase mem limit of snooper ([#546](https://github.com/crytic/ethereum-package/issues/546)) ([6ba5770](https://github.com/crytic/ethereum-package/commit/6ba577006e6f6eb0b477619399edb232f4ed9783))
* prysm beacon http url  ([#536](https://github.com/crytic/ethereum-package/issues/536)) ([4914531](https://github.com/crytic/ethereum-package/commit/4914531690eae32ba274e10ee7fa0ecf6d82ac68))
* prysm beacon_http_url ([#535](https://github.com/crytic/ethereum-package/issues/535)) ([ee7528c](https://github.com/crytic/ethereum-package/commit/ee7528c5d5872768e7ddc25e9da963e764e3b594))
* prysm vc ([#533](https://github.com/crytic/ethereum-package/issues/533)) ([72ddeb2](https://github.com/crytic/ethereum-package/commit/72ddeb25c1bb0a8132c1a3a73bd8f7764cb01659))
* remove un-needed prysm vc check ([#542](https://github.com/crytic/ethereum-package/issues/542)) ([f6326fe](https://github.com/crytic/ethereum-package/commit/f6326fe2119648478ab1bfc90220cbd4b4e12cac))
* set application protocol to be http for rpc ([#548](https://github.com/crytic/ethereum-package/issues/548)) ([905de7c](https://github.com/crytic/ethereum-package/commit/905de7c3635c3c057f67ae6589d708d9dc6d5ddd))
* set the correct default vc image ([#544](https://github.com/crytic/ethereum-package/issues/544)) ([953741d](https://github.com/crytic/ethereum-package/commit/953741d824a4a76a1194c2643012bf738669c3ad))
* uniformize keymanager ([#534](https://github.com/crytic/ethereum-package/issues/534)) ([a6a2830](https://github.com/crytic/ethereum-package/commit/a6a2830e90919999c6c391e9aa832094cf440d35))
* update prometheus api ([#539](https://github.com/crytic/ethereum-package/issues/539)) ([d2b9fb8](https://github.com/crytic/ethereum-package/commit/d2b9fb8961eac8a712af36f49ac8a1f918dabb6b))
* update vc &lt;&gt; cl matrix ([#564](https://github.com/crytic/ethereum-package/issues/564)) ([0ffcf74](https://github.com/crytic/ethereum-package/commit/0ffcf74cf3a83b0c462bc26d07254160b132b27a))
* update vc compatibility matrix ([#543](https://github.com/crytic/ethereum-package/issues/543)) ([58c4684](https://github.com/crytic/ethereum-package/commit/58c4684594711ee58bf117c31d5cf688d476892e))
* use `minimal-preset` images for dora & assertoor when minimal preset is used ([#532](https://github.com/crytic/ethereum-package/issues/532)) ([ad7773e](https://github.com/crytic/ethereum-package/commit/ad7773e86f1e1bb1f48b96e5126231fd060822e8))

## [2.1.0](https://github.com/crytic/ethereum-package/compare/2.0.0...2.1.0) (2024-03-28)


### Features

* add beacon snooper ([#520](https://github.com/crytic/ethereum-package/issues/520)) ([7e36191](https://github.com/crytic/ethereum-package/commit/7e361913c754ddf37eaf2cf3ad4a93aed8770899))
* add BN&lt;&gt;CL compatibility matrix to readme ([#519](https://github.com/crytic/ethereum-package/issues/519)) ([177beeb](https://github.com/crytic/ethereum-package/commit/177beeb9b46f61b3dd3dc3009ff2abf9b576c569))
* add grandine ([#517](https://github.com/crytic/ethereum-package/issues/517)) ([3ac4d2a](https://github.com/crytic/ethereum-package/commit/3ac4d2a4fae1c33ff658f0f43657a09522348127))
* enable preset to be set, mainnet/minimal ([#524](https://github.com/crytic/ethereum-package/issues/524)) ([f6e1b13](https://github.com/crytic/ethereum-package/commit/f6e1b136ef6b884e540c1289b8acc2b4d359e6ce))
* make deneb genesis default ([#518](https://github.com/crytic/ethereum-package/issues/518)) ([49509b9](https://github.com/crytic/ethereum-package/commit/49509b9ecb8b00d361e4119ee053ba86c366619e))
* make keymanager optional ([#523](https://github.com/crytic/ethereum-package/issues/523)) ([969012c](https://github.com/crytic/ethereum-package/commit/969012c3b504be1c475bd583675857d0605ed430))
* update verkle genesis + add besu support to verkle testing  ([#512](https://github.com/crytic/ethereum-package/issues/512)) ([0615cd1](https://github.com/crytic/ethereum-package/commit/0615cd1b4466d8f63e3adb721d97ee768211114f))


### Bug Fixes

* architecture.md ([#514](https://github.com/crytic/ethereum-package/issues/514)) ([f0ec4f0](https://github.com/crytic/ethereum-package/commit/f0ec4f076837b282a8972bd2211a0522ed67a06b))
* blobscan network name ([#516](https://github.com/crytic/ethereum-package/issues/516)) ([83c2a55](https://github.com/crytic/ethereum-package/commit/83c2a5592445c0efc10ab418d87ab2ecd4d10cf4))
* **blobscan:** update healthcheck endpoint ([#513](https://github.com/crytic/ethereum-package/issues/513)) ([8b2fc61](https://github.com/crytic/ethereum-package/commit/8b2fc61f77b53642441d3bd0bdeea89b2a2d35eb))
* separate vc ([#526](https://github.com/crytic/ethereum-package/issues/526)) ([baa04e9](https://github.com/crytic/ethereum-package/commit/baa04e9118f39b10ed7d867eec164483c6fd807d))
* Updated Readme with VCs supported by Grandine BN ([#527](https://github.com/crytic/ethereum-package/issues/527)) ([9cbe0b3](https://github.com/crytic/ethereum-package/commit/9cbe0b368205f70ee274d9c0c57f634f9621e6d7))
* use correct dora & assertoor images ([#522](https://github.com/crytic/ethereum-package/issues/522)) ([2a8d73a](https://github.com/crytic/ethereum-package/commit/2a8d73aba35bf26bfcd474036bac32c4f5713e35))
* use new validator names in assertoor config ([#521](https://github.com/crytic/ethereum-package/issues/521)) ([f595eb9](https://github.com/crytic/ethereum-package/commit/f595eb9a75e8c2147d530d1a70e6ccb9f3542257))

## [2.0.0](https://github.com/crytic/ethereum-package/compare/1.4.0...2.0.0) (2024-03-08)


### ⚠ BREAKING CHANGES

* participant_network & rename participant fields. ([#508](https://github.com/crytic/ethereum-package/issues/508))
* add node selectors features ([#491](https://github.com/crytic/ethereum-package/issues/491))

### Features

* add keymanager to all validator processes ([#502](https://github.com/crytic/ethereum-package/issues/502)) ([836eda4](https://github.com/crytic/ethereum-package/commit/836eda4eed3776dd406d354343655c0ff8b9d2b6))
* add nimbus-eth1 ([#496](https://github.com/crytic/ethereum-package/issues/496)) ([d599729](https://github.com/crytic/ethereum-package/commit/d599729295aa3274d23e4e8e99b56288cde3fc04))
* add node selectors features ([#491](https://github.com/crytic/ethereum-package/issues/491)) ([316d42f](https://github.com/crytic/ethereum-package/commit/316d42fbaeb2d7bc1d580823a6c70b1c2dfe3746))
* allow more detailed additional test configurations in assertoor_params ([#498](https://github.com/crytic/ethereum-package/issues/498)) ([fe2de7e](https://github.com/crytic/ethereum-package/commit/fe2de7e5a5e2446ebb0a0b191f5aa6783e132426))
* enable api in assertoor config ([#495](https://github.com/crytic/ethereum-package/issues/495)) ([9ceae9c](https://github.com/crytic/ethereum-package/commit/9ceae9c74405db4e1ab6e02de541577d078434ae))
* enable dencun-genesis ([#500](https://github.com/crytic/ethereum-package/issues/500)) ([beb764f](https://github.com/crytic/ethereum-package/commit/beb764fb9a18fcb09cb7d3d9ee48e4826595512d))
* make snapshot url configurable ([#507](https://github.com/crytic/ethereum-package/issues/507)) ([6fa0475](https://github.com/crytic/ethereum-package/commit/6fa04751cd1277a4870dc45144e15ffa5d637b93))
* parameterize mev-boost args ([#400](https://github.com/crytic/ethereum-package/issues/400)) ([e48483a](https://github.com/crytic/ethereum-package/commit/e48483a130ba227dafd0d0fd9ee66c6cecc3bfce))
* separate validator clients from CL clients ([#497](https://github.com/crytic/ethereum-package/issues/497)) ([90da2c3](https://github.com/crytic/ethereum-package/commit/90da2c33a77b4a0ac620ae665899963256a1ae0a))


### Bug Fixes

* fix end index in validator ranges file ([#509](https://github.com/crytic/ethereum-package/issues/509)) ([da55be8](https://github.com/crytic/ethereum-package/commit/da55be84861e93ce777076e545abee35ff2d51ce))
* lh vc flag logic ([#506](https://github.com/crytic/ethereum-package/issues/506)) ([bc5e725](https://github.com/crytic/ethereum-package/commit/bc5e725edf8c917d409e6de6ce838797ad166173))
* nimbus-eth1 advertise proper extip ([#501](https://github.com/crytic/ethereum-package/issues/501)) ([1d5a779](https://github.com/crytic/ethereum-package/commit/1d5a7792c8175d1fc85e424b5ddf60baec551821))
* README global node selector ([#504](https://github.com/crytic/ethereum-package/issues/504)) ([f9343a2](https://github.com/crytic/ethereum-package/commit/f9343a2914456196e1209336c426b6ad44958428))
* use the cl as the default validator image if none are defined ([#503](https://github.com/crytic/ethereum-package/issues/503)) ([181dd04](https://github.com/crytic/ethereum-package/commit/181dd04c2db17c58cb9370b0d24e12e4c191a13d))


### Code Refactoring

* participant_network & rename participant fields. ([#508](https://github.com/crytic/ethereum-package/issues/508)) ([fab341b](https://github.com/crytic/ethereum-package/commit/fab341b158329b9e8c2b590dc63127dfd1d2495f))

## [1.4.0](https://github.com/crytic/ethereum-package/compare/1.3.0...1.4.0) (2024-02-09)


### Features

* Add suave-enabled geth support ([#489](https://github.com/crytic/ethereum-package/issues/489)) ([631eaf3](https://github.com/crytic/ethereum-package/commit/631eaf3e621c90d5b546a1c005d8e31e06263aa4))
* add support for custom assertoor images & use assertoor image with verkle support for verkle chains ([#483](https://github.com/crytic/ethereum-package/issues/483)) ([2d8a143](https://github.com/crytic/ethereum-package/commit/2d8a143f753eaa3ec13abe4ebbb57bf82548b3fb))
* add verkle-gen-devnet-3 ([#487](https://github.com/crytic/ethereum-package/issues/487)) ([1e543e8](https://github.com/crytic/ethereum-package/commit/1e543e873c06e86a6448f8e88c53fb1bde35338e))
* blockscout support with sc verification ([#481](https://github.com/crytic/ethereum-package/issues/481)) ([b3418cf](https://github.com/crytic/ethereum-package/commit/b3418cf1545378d4b412966b9c33f650141aec04))
* enable custom resource limit per network ([#471](https://github.com/crytic/ethereum-package/issues/471)) ([5db6611](https://github.com/crytic/ethereum-package/commit/5db6611ab831a92212a21859b42a911cd12bce0c))
* enable shadowforking ([#475](https://github.com/crytic/ethereum-package/issues/475)) ([b788b18](https://github.com/crytic/ethereum-package/commit/b788b18eead00622ab960a4853c8e24b09c16a26))
* improve built-in assertoor tests ([#488](https://github.com/crytic/ethereum-package/issues/488)) ([d596699](https://github.com/crytic/ethereum-package/commit/d5966991653ad48094cf71d3c01612349a651877))
* we no longer need 4788 deployer ([#485](https://github.com/crytic/ethereum-package/issues/485)) ([abdfc2c](https://github.com/crytic/ethereum-package/commit/abdfc2c3e73550069c2fbe0df5202f7f227a00cd))


### Bug Fixes

* add more prefund addresses for verkle-gen ([#482](https://github.com/crytic/ethereum-package/issues/482)) ([01868fc](https://github.com/crytic/ethereum-package/commit/01868fcb604852cf66474fc9de9a53a7b87b7bc3))
* bump verkle genesis generator ([#486](https://github.com/crytic/ethereum-package/issues/486)) ([79dc5e1](https://github.com/crytic/ethereum-package/commit/79dc5e19713d3f898f6255394290497d016f32d5))
* use latest stable image for assertoor ([#484](https://github.com/crytic/ethereum-package/issues/484)) ([bbe0b16](https://github.com/crytic/ethereum-package/commit/bbe0b16e948fc50f51273e2f0ab91503603e9fc9))

## [1.3.0](https://github.com/crytic/ethereum-package/compare/1.2.0...1.3.0) (2024-01-22)


### Features

* add assertoor to additional toolings ([#419](https://github.com/crytic/ethereum-package/issues/419)) ([76dde3e](https://github.com/crytic/ethereum-package/commit/76dde3ed421da0d7f8ba16f46565b07019be76c0))
...
* add pitfalls for persistent storage as a warning ([#441](https://github.com/crytic/ethereum-package/issues/441)) ([69da8f0](https://github.com/crytic/ethereum-package/commit/69da8f04fcfd5ce19365bd89ca73c13cbc40d76a))
...
* Add Xatu Sentry ([#466](https://github.com/crytic/ethereum-package/issues/466)) ([b9523cb](https://github.com/crytic/ethereum-package/commit/b9523cb7083be78c96bb88a7ca86d142cb0eec1d))
* enable checkpoint sync for devnets ([#448](https://github.com/crytic/ethereum-package/issues/448)) ([b367cfe](https://github.com/crytic/ethereum-package/commit/b367cfe875900bdc8aa70dc8b1d8aebdbcf81593))
...
* enable syncing ephemery ([#459](https://github.com/crytic/ethereum-package/issues/459)) ([f8289cb](https://github.com/crytic/ethereum-package/commit/f8289cb49f68dd488635d2313c007ee7c2f4dbf3))
* enable syncing shadowforks ([#457](https://github.com/crytic/ethereum-package/issues/457)) ([313a586](https://github.com/crytic/ethereum-package/commit/313a586965efa6739e8d4055f1263a89d48ff499))


### Bug Fixes

* add CL genesis delay to final genesis time ([#469](https://github.com/crytic/ethereum-package/issues/469)) ([e36027b](https://github.com/crytic/ethereum-package/commit/e36027b91de0ae8943012ffd6ba776142d2e2d78))
* add prysm-multiarch upstream image ([#451](https://github.com/crytic/ethereum-package/issues/451)) ([6feba23](https://github.com/crytic/ethereum-package/commit/6feba237fbdfae021402ceeec89baa75df6d83d5))
* added supprot for boot enr file ([#456](https://github.com/crytic/ethereum-package/issues/456)) ([fd26e5c](https://github.com/crytic/ethereum-package/commit/fd26e5c31609b48e1d6718f72d295a27a7d84a49))
...
* dora template fix ([#452](https://github.com/crytic/ethereum-package/issues/452)) ([f9243ea](https://github.com/crytic/ethereum-package/commit/f9243ea8cdec8a0145206831c9c043269c80e863))
* enable ws for geth ([#446](https://github.com/crytic/ethereum-package/issues/446)) ([d5bf451](https://github.com/crytic/ethereum-package/commit/d5bf45150dc09432bb84b366d2deda8c6036afea))
* erigon chain should be set to dev ([#447](https://github.com/crytic/ethereum-package/issues/447)) ([1f40d84](https://github.com/crytic/ethereum-package/commit/1f40d8402666310cad81066852110aa20627471b))
* erigon command arg ([#454](https://github.com/crytic/ethereum-package/issues/454)) ([5ae56a1](https://github.com/crytic/ethereum-package/commit/5ae56a17773122827b074963dee40a43a00478ea))
...
* guid fix for besu/teku/erigon/nimbus ([#443](https://github.com/crytic/ethereum-package/issues/443)) ([2283464](https://github.com/crytic/ethereum-package/commit/2283464b614b0ade4aa98fccd842e8e4b23e188a))
* increase db size for geth ([#453](https://github.com/crytic/ethereum-package/issues/453)) ([0c67998](https://github.com/crytic/ethereum-package/commit/0c67998567a4ab60dd0355b734076ee47b988326))
* logging bug ([#462](https://github.com/crytic/ethereum-package/issues/462)) ([f6098a1](https://github.com/crytic/ethereum-package/commit/f6098a1572923655426f25eab936b7a0b9fbc116))
...
* re-add networkid ([#464](https://github.com/crytic/ethereum-package/issues/464)) ([4d96409](https://github.com/crytic/ethereum-package/commit/4d96409cdbd1a367fc1e924cb9183eadce4eeae7))
* typo ([#445](https://github.com/crytic/ethereum-package/issues/445)) ([e61c58a](https://github.com/crytic/ethereum-package/commit/e61c58a8c2944cbf2699bd75d25a2e63d8e0621c))
* Update nethermind to expose host on 0.0.0.0 ([#467](https://github.com/crytic/ethereum-package/issues/467)) ([0bd29dd](https://github.com/crytic/ethereum-package/commit/0bd29dd7d61dae77b7820f79d46e8a52e74267c2))
* use all enrs for nimbus via bootstrap file ([#450](https://github.com/crytic/ethereum-package/issues/450)) ([bb5a0c1](https://github.com/crytic/ethereum-package/commit/bb5a0c1b5b051b23b185cfd366a2dfed3f44d903))

## [1.2.0](https://github.com/crytic/ethereum-package/compare/1.1.0...1.2.0) (2024-01-03)
...
* add files artifact uuid information to cl client context ([#418](https://github.com/crytic/ethereum-package/issues/418)) ([806ef47](https://github.com/crytic/ethereum-package/commit/806ef47aefc4e22f79b6a96ad941b72ac5d5c099))
...
* allow 0 genesis delay ([#383](https://github.com/crytic/ethereum-package/issues/383)) ([11c2693](https://github.com/crytic/ethereum-package/commit/11c26939c53a6db0d8816254f6b7ac535535e754))
...
## [1.1.0](https://github.com/crytic/ethereum-package/compare/1.0.0...1.1.0) (2023-11-30)
...
## [1.0.0](https://github.com/crytic/ethereum-package/compare/0.6.1...1.0.0) (2023-10-25)
...
* **tooling:** Add Ethereum Metrics Exporter ([#331](https://github.com/crytic/ethereum-package/issues/331)) ([de5eee8](https://github.com/crytic/ethereum-package/commit/de5eee82a7757b218a902e0bef36dae42e966b31))
...
## [0.6.1](https://github.com/crytic/ethereum-package/compare/0.6.0...0.6.1) (2023-10-17)
...
## [0.6.0](https://github.com/crytic/ethereum-package/compare/0.5.1...0.6.0) (2023-10-17)
...
* editor config used tabs still ([#274](https://github.com/crytic/ethereum-package/issues/274)) ([7bbba4c](https://github.com/crytic/ethereum-package/commit/7bbba4c2b77abbc27efcb2a9af352af6cc932f9b))
...
## [0.5.0](https://github.com/crytic/ethereum-package/compare/0.4.0...0.5.0) (2023-09-28)
...
## [0.4.0](https://github.com/crytic/ethereum-package/compare/0.3.1...0.4.0) (2023-09-27)


### ⚠ BREAKING CHANGES

* merge eth-network-package onto ethereum-package ([#228](https://github.com/crytic/ethereum-package/issues/228))

### Code Refactoring

* merge eth-network-package onto ethereum-package ([#228](https://github.com/crytic/ethereum-package/issues/228)) ([b72dad3](https://github.com/crytic/ethereum-package/commit/b72dad35ac0991a6a33e8720aaa5c9455d34752b))

## [0.3.1](https://github.com/crytic/ethereum-package/compare/0.3.0...0.3.1) (2023-09-26)
...
## [0.3.0](https://github.com/crytic/ethereum-package/compare/0.2.0...0.3.0) (2023-09-03)
...
* make besu a bootnode ([29296cd](https://github.com/crytic/ethereum-package/commit/29296cd1c78615743d32f68ca50fb51121c5921c))
...
* pin postgres package ([#174](https://github.com/crytic/ethereum-package/issues/174)) ([6b8d9d3](https://github.com/crytic/ethereum-package/commit/6b8d9d39fd06d1dc01d4f3cbbc6c20f9f962bb6a))
...
* update nightly runner ([#163](https://github.com/crytic/ethereum-package/issues/163)) ([4eba65d](https://github.com/crytic/ethereum-package/commit/4eba65df4fd29ece8a89ac77066e68d330fc2297))
