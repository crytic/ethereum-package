...
Next, we plug the generated genesis data [into EL client "launchers"](https://github.com/crytic/ethereum-package/tree/main/src/participant_network/el) to start a mining network of EL nodes. The launchers come with a `launch` function that consumes EL genesis data and produces information about the running EL client node. Running EL node information is represented by [an `el_context` struct](https://github.com/crytic/ethereum-package/blob/main/src/participant_network/el/el_context.star). Each EL client type has its own launcher (e.g. [Geth](https://github.com/crytic/ethereum-package/tree/main/src/participant_network/el/geth), [Besu](https://github.com/crytic/ethereum-package/tree/main/src/participant_network/el/besu)) because each EL client will require different environment variables and flags to be set when launching the client's container.

### Starting CL clients

Once CL genesis data and keys have been created, the CL client nodes are started via [the CL client launchers](https://github.com/crytic/ethereum-package/tree/main/src/participant_network/cl). Just as with EL clients:

- CL client launchers implement come with a `launch` method
- One CL client launcher exists per client type (e.g. [Nimbus](https://github.com/crytic/ethereum-package/tree/main/src/participant_network/cl/nimbus), [Lighthouse](https://github.com/crytic/ethereum-package/tree/main/src/participant_network/cl/lighthouse))
- Launched CL node information is tracked in [a `cl_context` struct](https://github.com/crytic/ethereum-package/blob/main/src/participant_network/cl/cl_context.star)
...
- [Forkmon](https://github.com/crytic/ethereum-package/tree/main/src/el_forkmon), a "fork monitor" web UI for visualizing the CL clients' forks
- [Prometheus](https://github.com/crytic/ethereum-package/tree/main/src/prometheus) for collecting client node metrics
- [Grafana](https://github.com/crytic/ethereum-package/tree/main/src/grafana) for visualizing client node metrics
- [An ETH transaction spammer](https://github.com/crytic/ethereum-package/tree/main/src/transaction_spammer), which [has been forked off](https://github.com/kurtosis-tech/tx-fuzz) of [Marius' transaction spammer code](https://github.com/MariusVanDerWijden/tx-fuzz) so that it can run as a container
...
[main-function]: https://github.com/crytic/ethereum-package/blob/main/main.star#22
[package-io]: https://github.com/crytic/ethereum-package/tree/main/src/package_io
[participant-network]: https://github.com/crytic/ethereum-package/tree/main/src/participant_network
[ethereum-genesis-generator]: https://github.com/crytic/ethereum-genesis-generator
[static-files]: https://github.com/crytic/ethereum-package/tree/main/static_files
[testnet-verifier]: https://github.com/crytic/ethereum-package/tree/main/src/testnet_verifier
